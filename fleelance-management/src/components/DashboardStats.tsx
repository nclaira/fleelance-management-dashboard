    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
        <div className="flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-2xl font-semibold text-gray-800">{stats.paidProjects}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
        <div className="flex items-center">
          ...
          <div className="ml-4">
            <p className="text-sm font-medium text-gray-600">Unpaid Projects</p>
            <p className="text-2xl font-semibold text-gray-800">{stats.unpaidProjects}</p>
          </div>
        </div>
      </div>
    </div>
